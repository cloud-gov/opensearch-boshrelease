...
LOG="1012 <13>1 $(date -u +"%Y-%m-%dT%H:%M:%SZ") 0.0.0.0 d20d2020-d200-d200-d200-d20d20d20d20 [SMOKE/TEST/ERRAND/0] - [job=smoke_tests index=0 app_id=smoke_tests deployment=cf-development instance_id=0  origin=rep]  {\"smoke-id\":\"$SMOKE_ID\"}"
