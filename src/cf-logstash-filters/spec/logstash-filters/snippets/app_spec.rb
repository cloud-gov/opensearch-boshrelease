    ...
    context "succeeded" do
      when_parsing_log(
        ...
        it "sets @source fields" do
          ...
          expect(parsed_results.get("@source")["host"]).to eq "127.0.0.1"
