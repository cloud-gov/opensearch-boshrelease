  ...
  describe "#fields when message is" do
    context "request format" do
      when_parsing_log(
          ...
          "@message" => '127.0.0.1 - [17/Aug/2019:11:59:22 +0000] "GET /healthz HTTP/1.1" 200 248 "-" "ccng_monit_http_healthcheck" 127.0.0.1 vcap_request_id:f7c00c99-052c-41ec-9c7d-89c2826dcc60 response_time:0.008'
      ) do
        ...
        it "sets [cloud_controller_ng] fields from grok" do
          ...
          expect(parsed_results.get("Request_Host")).to eq "127.0.0.1"
          ...
          expect(parsed_results.get("Backend_Address")).to eq "127.0.0.1"
